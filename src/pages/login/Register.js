...
import Small from '../../component/spiner/small'
      ...
      console.log(result);
        ...
        .then(
          verifyEmail().then(() => {
            ...
            toast.success('success fully verified')
...
<div className='flex justify-center items-center pt-8'>
      <div className='flex flex-col max-w-md p-6 rounded-md sm:p-10 bg-gray-100 text-gray-900'>
        ...
        <div className='flex justify-center space-x-4'>
          <button onClick={signinwithPop} aria-label='Log in with Google' className='p-3 rounded-sm'>
            <svg
